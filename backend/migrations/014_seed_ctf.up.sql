...
VALUES
    ...
    -- 攻防赛报名
    (920000000000025004, 920000000000020003, 920000000000023004, 910000000000001101, 2, NOW() - INTERVAL '5 days'),
    (920000000000025005, 920000000000020003, 920000000000023005, 910000000000001102, 2, NOW() - INTERVAL '5 days'),
    (920000000000025006, 920000000000020003, 920000000000023006, 910000000000001203, 2, NOW() - INTERVAL '4 days')
ON CONFLICT (id) DO NOTHING;
