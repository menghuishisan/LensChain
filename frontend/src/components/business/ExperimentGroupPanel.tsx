...
// 模块04实验分组面板，展示角色分配、组内进度和实时消息。

import { MessageSquare, RefreshCcw, Send, Users } from "lucide-react";
...
import { useExperimentGroupChatRealtime } from "@/hooks/useExperimentRealtime";
