...
export default function CtfAttackDefensePage({ params }: { params: { id: string } }) {
  return <PermissionGate allowedRoles={["student"]}><div className="space-y-5"><AttackDefenseRoundPanel competitionID={params.id} /><CtfLeaderboard competitionID={params.id} /></div></PermissionGate>;
}
